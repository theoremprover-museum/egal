...
let rec tm_pack m sof sdel nf =
  ...
  | TpAp(TpAp(TpAp(TmH(h),a1),a2),a3) ->
	...
	try
	  ...
	  if tp_closed_p a1 && tp_closed_p a2 && tp_closed_p a3 then (*** If all the types are closed, then expand and pack ***)
  ...
  | TpAp(TpAp(TmH(h),a1),a2) ->
	...
	try
	  ...
	  if tp_closed_p a1 && tp_closed_p a2 then (*** If all the types are closed, then expand and pack ***)
  ...
  | TpAp(TmH(h),a1) ->
	...
	try
	  ...
	  if tp_closed_p a1 then (*** If all the types are closed, then expand and pack ***)
